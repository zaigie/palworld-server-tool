...
build-all:
	...
	mkdir -p dist/windows_x86 && mkdir -p dist/linux_amd64 && mkdir -p dist/linux_aarch64 && mkdir -p dist/darwin_arm64
	...
	cd dist && zip -p -r ${PREFIX}_windows_x86.zip windows_x86/* && tar -czf ${PREFIX}_linux_amd64.tar.gz linux_amd64/* && tar -czf ${PREFIX}_linux_aarch64.tar.gz linux_aarch64/* && tar -czf ${PREFIX}_darwin_arm64.tar.gz darwin_arm64/* && cd ..
# show help
help:
	@echo ''
	@echo 'Usage:'
